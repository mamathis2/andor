...
void SetSystem(void)
{
  ...
  GetWindowText(ebHStart,aBuffer2,5);
  hstart=atof(aBuffer2);

  GetWindowText(ebHEnd,aBuffer2,5);
  hend=atof(aBuffer2);

  GetWindowText(ebVStart,aBuffer2,5);
  vstart=atof(aBuffer2);

  GetWindowText(ebVEnd,aBuffer2,5);
  vend=atof(aBuffer2);

  GetWindowText(ebHBin,aBuffer2,5);
  hbin=atof(aBuffer2);

  GetWindowText(ebVBin,aBuffer2,5);
  vbin=atof(aBuffer2);
