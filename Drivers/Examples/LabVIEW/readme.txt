...
All Andor SDK function wrappers are present in a LabVIEW library file, "atmcd64d.llb", installed in your user.lib directory in you LabVIEW install folder.
...
4) Navigate to the user.lib directory and select "atmcd64d.llb" - The submenu with all SDK functions has been added.
