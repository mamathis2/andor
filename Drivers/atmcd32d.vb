...
Public Module AndorSDK
  ...
  Public Const AC_CAMERATYPE_VOLMOS As UInteger = 22
  ...
  Public Const AC_SETFUNCTION_GATEDELAYSTEP As UInteger = &H200000
  ...
  Public Const AC_SETFUNCTION_REGISTERPACK As UInteger = &H2000000
  Public Const AC_SETFUNCTION_PRESCANS As UInteger = &H4000000
  Public Const AC_SETFUNCTION_GATEWIDTHSTEP As UInteger = &H8000000
  Public Const AC_SETFUNCTION_EXTENDED_CROP_MODE As UInteger = &H10000000
  ...
  Public Const AC_GETFUNCTION_GATEDELAYSTEP As UInteger = &H1000
  ...
  Public Const AC_GETFUNCTION_GATEWIDTHSTEP As UInteger = &H10000
...
Declare Function GetBaselineClamp Lib "atmcd32d.dll" (ByRef state As Integer) As UInteger
...
Declare Function GetCountConvertWavelengthRange Lib "atmcd32d.dll" (ByRef minval As Single, ByRef maxval As Single) As UInteger
...
Declare Function GetDDGExternalOutputTime Lib "atmcd32d.dll" (ByVal uiIndex As UInteger, ByRef puiDelay As UInt64, ByRef puiWidth As UInt64) As UInteger
Declare Function GetDDGTTLGateWidth Lib "atmcd32d.dll" (ByVal opticalWidth As UInt64, ByRef ttlWidth As UInt64) As UInteger
Declare Function GetDDGGateTime Lib "atmcd32d.dll" (ByRef puiDelay As UInt64, ByRef puiWidth As UInt64) As UInteger
...
Declare Function GetDDGIOCPeriod Lib "atmcd32d.dll" (ByRef period As UInt64) As UInteger
Declare Function GetDDGIOCPulses Lib "atmcd32d.dll" (ByRef pulses As Integer) As UInteger
Declare Function GetDDGIOCTrigger Lib "atmcd32d.dll" (ByRef trigger As UInteger) As UInteger
Declare Function GetDDGOpticalWidthEnabled Lib "atmcd32d.dll" (ByRef puiEnabled As UInteger) As UInteger
...
Declare Function GetDDGWidthStepCoefficients Lib "atmcd32d.dll" (ByVal mode As UInteger, ByRef p1 As Double, ByRef p2 As Double) As UInteger
Declare Function GetDDGStepMode Lib "atmcd32d.dll" (ByRef mode As UInteger) As UInteger
Declare Function GetDDGWidthStepMode Lib "atmcd32d.dll" (ByRef mode As UInteger) As UInteger
...
Declare Function GetEMAdvanced Lib "atmcd32d.dll" (ByRef state As Integer) As UInteger
...
Declare Function GetMaximumNumberRingExposureTimes Lib "atmcd32d.dll" (ByRef number As Integer) As UInteger
...
Declare Function GetRelativeImageTimes Lib "atmcd32d.dll" (ByVal first As Integer, ByVal last As Integer, ByRef arr As UInt64, ByVal size As Integer) As UInteger
...
Declare Function GetNumberPhotonCountingDivisions Lib "atmcd32d.dll" (ByRef noOfDivisions As UInteger) As UInteger
...
Declare Function GetPreAmpGainText Lib "atmcd32d.dll" (ByVal index As Integer, ByVal name As String, ByVal length As Integer) As UInteger
Declare Function GetDualExposureTimes Lib "atmcd32d.dll" (ByRef exposure1 As Single, ByRef exposure2 As Single) As UInteger
Declare Function GetQE Lib "atmcd32d.dll" (ByVal sensor As String, ByVal wavelength As Single, ByVal mode As Integer, ByRef QE As Single) As UInteger
...
Declare Function GetSDK3Handle Lib "atmcd32d.dll" (ByRef Handle As Integer) As UInteger
...
Declare Function GetShutterMinTimes Lib "atmcd32d.dll" (ByRef minclosingtime As Integer, ByRef minopeningtime As Integer) As UInteger
...
Declare Function GetVSAmplitudeString Lib "atmcd32d.dll" (ByVal index As Integer, ByRef text As String) As UInteger
Declare Function GetVSAmplitudeFromString Lib "atmcd32d.dll" (ByRef text As String, ByRef index As Integer) As UInteger
Declare Function GetVSAmplitudeValue Lib "atmcd32d.dll" (ByVal index As Integer, ByRef value As Integer) As UInteger
...
Declare Function IsCountConvertModeAvailable Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
...
Declare Function SetCameraLinkMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
Declare Function SetCameraStatusEnable Lib "atmcd32d.dll" (ByVal Enable As Integer) As UInteger
Declare Function SetChargeShifting Lib "atmcd32d.dll" (ByVal NumberRows As Integer, ByVal NumberRepeats As Integer) As UInteger
...
Declare Function SetDDGExternalOutputTime Lib "atmcd32d.dll" (ByVal uiIndex As UInteger, ByVal uiDelay As UInt64, ByVal uiWidth As UInt64) As UInteger
...
Declare Function SetDDGGateTime Lib "atmcd32d.dll" (ByVal uiDelay As UInt64, ByVal uiWidth As UInt64) As UInteger
...
Declare Function SetDDGIOCPeriod Lib "atmcd32d.dll" (ByVal period As UInt64) As UInteger
Declare Function SetDDGIOCTrigger Lib "atmcd32d.dll" (ByVal trigger As UInteger) As UInteger
Declare Function SetDDGOpticalWidthEnabled Lib "atmcd32d.dll" (ByVal uiEnabled As UInteger) As UInteger
...
Declare Function SetDDGWidthStepCoefficients Lib "atmcd32d.dll" (ByVal mode As UInteger, ByVal p1 As Double, ByVal p2 As Double) As UInteger
Declare Function SetDDGStepMode Lib "atmcd32d.dll" (ByVal mode As UInteger) As UInteger
Declare Function SetDDGWidthStepMode Lib "atmcd32d.dll" (ByVal mode As UInteger) As UInteger
...
Declare Function SetIsolatedCropModeEx Lib "atmcd32d.dll" (ByVal active As Long, ByVal cropheight As Long, ByVal cropwidth As Long, ByVal vbin As Long, ByVal hbin As Long, ByVal cropleft As Long, ByVal cropbottom As Long) As UInteger
...
Declare Function SetDualExposureTimes Lib "atmcd32d.dll" (ByVal expTime1 As Single, ByVal expTime2 As Single) As UInteger
...
Declare Function SetReadoutRegisterPacking Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
...
Declare Function SetSpoolThreadCount Lib "atmcd32d.dll" (ByVal count As Integer) As UInteger
...
Declare Function OA_GetModeAcqParams Lib "atmcd32d.dll" (ByRef pcModeName As String, ByRef pcListOfParams As String) As UInteger
Declare Function OA_GetUserModeNames Lib "atmcd32d.dll" (ByRef pcListOfModes As String) As UInteger
Declare Function OA_GetPreSetModeNames Lib "atmcd32d.dll" (ByRef pcListOfModes As String) As UInteger
...
Declare Function Filter_SetMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
Declare Function Filter_GetMode Lib "atmcd32d.dll" (ByRef mode As Integer) As UInteger
Declare Function Filter_SetThreshold Lib "atmcd32d.dll" (ByVal threshold As Single) As UInteger
Declare Function Filter_GetThreshold Lib "atmcd32d.dll" (ByRef threshold As Single) As UInteger
Declare Function Filter_SetDataAveragingMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
Declare Function Filter_GetDataAveragingMode Lib "atmcd32d.dll" (ByRef mode As Integer) As UInteger
Declare Function Filter_SetAveragingFrameCount Lib "atmcd32d.dll" (ByVal frames As Integer) As UInteger
Declare Function Filter_GetAveragingFrameCount Lib "atmcd32d.dll" (ByRef frames As Integer) As UInteger
Declare Function Filter_SetAveragingFactor Lib "atmcd32d.dll" (ByVal averagingFactor As Integer) As UInteger
Declare Function Filter_GetAveragingFactor Lib "atmcd32d.dll" (ByRef averagingFactor As Integer) As UInteger

Declare Function PostProcessNoiseFilter Lib "atmcd32d.dll" (ByRef pInputImage As Integer, ByRef pOutputImage As Integer, ByVal iOutputBufferSize As Integer, ByVal iBaseline As Integer, ByVal iMode As Integer, ByVal fThreshold As Single, ByVal iHeight As Integer, ByVal iWidth As Integer) As UInteger
Declare Function PostProcessCountConvert Lib "atmcd32d.dll" (ByRef pInputImage As Integer, ByRef pOutputImage As Integer, ByVal iOutputBufferSize As Integer, ByVal iNumImages As Integer, ByVal iBaseline As Integer, ByVal iMode As Integer, ByVal iEmGain As Integer, ByVal fQE As Single, ByVal fSensitivity As Single, ByVal iHeight As Integer, ByVal iWidth As Integer) As UInteger
Declare Function PostProcessPhotonCounting Lib "atmcd32d.dll" (ByRef pInputImage As Integer, ByRef pOutputImage As Integer, ByVal iOutputBufferSize As Integer, ByVal iNumImages As Integer, ByVal iNumframes As Integer, ByVal iNumberOfThresholds As Integer, ByRef pfThreshold As Single, ByVal iHeight As Integer, ByVal iWidth As Integer) As UInteger
Declare Function PostProcessDataAveraging Lib "atmcd32d.dll" (ByRef pInputImage As Integer, ByRef pOutputImage As Integer, ByVal iOutputBufferSize As Integer, ByVal iNumImages As Integer, ByVal iAveragingFilterMode As Integer, ByVal iHeight As Integer, ByVal iWidth As Integer, ByVal iFrameCount As Integer, ByVal iAveragingFactor As Integer) As UInteger
