...
Declare Function GetBaselineClamp Lib "atmcd32d.dll" (state As Long) As Long
...
Declare Function GetCountConvertWavelengthRange Lib "atmcd32d.dll" (minval As Single, maxval As Single) As Long
...
Declare Function GetVB6DDGExternalOutputTime Lib "atmcd32dvb6Helper.dll" (ByVal uiIndex As Long, puiDelay_us As Long, puiDelay_ps As Long, puiWidth_us As Long, puiWidth_ps As Long) As Long
Declare Function GetVB6DDGTTLGateWidth Lib "atmcd32dvb6Helper.dll" (ByVal opticalWidth_us As Long, ByVal opticalWidth_ps As Long, ttlWidth_us As Long, ttlWidth_ps As Long) As Long
Declare Function GetVB6DDGGateTime Lib "atmcd32dvb6Helper.dll" (puiDelay_us As Long, puiDelay_ps As Long, puiWidth_us As Long, puiWidth_ps As Long) As Long
...
Declare Function GetVB6DDGIOCPeriod Lib "atmcd32dvb6Helper.dll" (period_us As Long, period_ps As Long) As Long
Declare Function GetDDGIOCPulses Lib "atmcd32d.dll" (pulses As Long) As Long
Declare Function GetDDGIOCTrigger Lib "atmcd32d.dll" (trigger As Long) As Long
Declare Function GetDDGOpticalWidthEnabled Lib "atmcd32d.dll" (puiEnabled As Long) As Long
...
Declare Function GetDDGWidthStepCoefficients Lib "atmcd32d.dll" (ByVal mode As Long, p1 As Double , p2 As Double ) As Long
Declare Function GetDDGStepMode Lib "atmcd32d.dll" (mode As Long) As Long
Declare Function GetDDGWidthStepMode Lib "atmcd32d.dll" (mode As Long) As Long
...
Declare Function GetEMAdvanced Lib "atmcd32d.dll" (state As Long) As Long
...
Declare Function GetMaximumNumberRingExposureTimes Lib "atmcd32d.dll" (number As Long) As Long
...
' Declare Function GetRelativeImageTimes Lib "atmcd32d.dll" (ByVal first As Long, ByVal last As Long, arr_us As Long, arr_ps As Long, ByVal size As Long) As Long
...
Declare Function GetNumberPhotonCountingDivisions Lib "atmcd32d.dll" (noOfDivisions As Long) As Long
...
Declare Function GetPreAmpGainText Lib "atmcd32d.dll" (ByVal index As Long, ByVal name As String, ByVal length As Long) As Long
Declare Function GetDualExposureTimes Lib "atmcd32d.dll" (exposure1 As Single, exposure2 As Single) As Long
Declare Function GetQE Lib "atmcd32d.dll" (ByVal sensor As String, ByVal wavelength As Single, ByVal mode As Long, QE As Single) As Long
...
Declare Function GetSDK3Handle Lib "atmcd32d.dll" (Handle As Long) As Long
...
Declare Function GetShutterMinTimes Lib "atmcd32d.dll" (minclosingtime As Long, minopeningtime As Long) As Long
...
Declare Function GetVSAmplitudeString Lib "atmcd32d.dll" (ByVal index As Long, text As String) As Long
Declare Function GetVSAmplitudeFromString Lib "atmcd32d.dll" (text As String, index As Long) As Long
Declare Function GetVSAmplitudeValue Lib "atmcd32d.dll" (ByVal index As Long, value As Long) As Long
...
Declare Function IsCountConvertModeAvailable Lib "atmcd32d.dll" (ByVal mode As Long) As Long
...
Declare Function SetCameraLinkMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function SetCameraStatusEnable Lib "atmcd32d.dll" (ByVal Enable As Long) As Long
Declare Function SetChargeShifting Lib "atmcd32d.dll" (ByVal NumberRows As Long, ByVal NumberRepeats As Long) As Long
...
Declare Function SetVB6DDGExternalOutputTime Lib "atmcd32dvb6Helper.dll" (ByVal uiIndex As Long, ByVal uiDelay_us As Long, ByVal uiDelay_ps As Long, ByVal uiWidth_us As Long, ByVal uiWidth_ps As Long) As Long
...
Declare Function SetVB6DDGGateTime Lib "atmcd32dvb6Helper.dll" (ByVal uiDelay_us As Long, ByVal uiDelay_ps As Long, ByVal uiWidth_us As Long, ByVal uiWidth_ps As Long) As Long
...
Declare Function SetVB6DDGIOCPeriod Lib "atmcd32dvb6Helper.dll" (ByVal period_us As Long, ByVal period_ps As Long) As Long
Declare Function SetDDGIOCTrigger Lib "atmcd32d.dll" (ByVal trigger As Long) As Long
Declare Function SetDDGOpticalWidthEnabled Lib "atmcd32d.dll" (ByVal uiEnabled As Long) As Long
...
Declare Function SetDDGWidthStepCoefficients Lib "atmcd32d.dll" (ByVal mode As Long, ByVal p1 As Double , ByVal p2 As Double ) As Long
Declare Function SetDDGStepMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function SetDDGWidthStepMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
...
Declare Function SetIsolatedCropModeEx Lib "atmcd32d.dll" (ByVal active As Long, ByVal cropheight As Long, ByVal cropwidth As Long, ByVal vbin As Long, ByVal hbin As Long, ByVal cropleft As Long, ByVal cropbottom As Long) As Long
...
Declare Function SetReadoutRegisterPacking Lib "atmcd32d.dll" (ByVal mode As Long) As Long
...
Declare Function SetSpoolThreadCount Lib "atmcd32d.dll" (ByVal count As Long) As Long
...
Declare Function OA_GetModeAcqParams Lib "atmcd32d.dll" (pcModeName As String, pcListOfParams As String) As Long
Declare Function OA_GetUserModeNames Lib "atmcd32d.dll" (pcListOfModes As String) As Long
Declare Function OA_GetPreSetModeNames Lib "atmcd32d.dll" (pcListOfModes As String) As Long
...
Declare Function Filter_SetMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function Filter_GetMode Lib "atmcd32d.dll" (mode As Long) As Long
Declare Function Filter_SetThreshold Lib "atmcd32d.dll" (ByVal threshold As Single) As Long
Declare Function Filter_GetThreshold Lib "atmcd32d.dll" (threshold As Single) As Long
Declare Function Filter_SetDataAveragingMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function Filter_GetDataAveragingMode Lib "atmcd32d.dll" (mode As Long) As Long
Declare Function Filter_SetAveragingFrameCount Lib "atmcd32d.dll" (ByVal frames As Long) As Long
Declare Function Filter_GetAveragingFrameCount Lib "atmcd32d.dll" (frames As Long) As Long
Declare Function Filter_SetAveragingFactor Lib "atmcd32d.dll" (ByVal averagingFactor As Long) As Long
Declare Function Filter_GetAveragingFactor Lib "atmcd32d.dll" (averagingFactor As Long) As Long

Declare Function PostProcessNoiseFilter Lib "atmcd32d.dll" (pInputImage As Long, pOutputImage As Long, ByVal iOutputBufferSize As Long, ByVal iBaseline As Long, ByVal iMode As Long, ByVal fThreshold As Single, ByVal iHeight As Long, ByVal iWidth As Long) As Long
Declare Function PostProcessCountConvert Lib "atmcd32d.dll" (pInputImage As Long, pOutputImage As Long, ByVal iOutputBufferSize As Long, ByVal iNumImages As Long, ByVal iBaseline As Long, ByVal iMode As Long, ByVal iEmGain As Long, ByVal fQE As Single, ByVal fSensitivity As Single, ByVal iHeight As Long, ByVal iWidth As Long) As Long
Declare Function PostProcessPhotonCounting Lib "atmcd32d.dll" (pInputImage As Long, pOutputImage As Long, ByVal iOutputBufferSize As Long, ByVal iNumImages As Long, ByVal iNumframes As Long, ByVal iNumberOfThresholds As Long, pfThreshold As Single, ByVal iHeight As Long, ByVal iWidth As Long) As Long
Declare Function PostProcessDataAveraging Lib "atmcd32d.dll" (pInputImage As Long, pOutputImage As Long, ByVal iOutputBufferSize As Long, ByVal iNumImages As Long, ByVal iAveragingFilterMode As Long, ByVal iHeight As Long, ByVal iWidth As Long, ByVal iFrameCount As Long, ByVal iAveragingFactor As Long) As Long
...
Global Const DRV_INVALID_COUNTCONVERT_MODE = 20101
...
Global Const DRV_OA_GET_CAMERA_ERROR = 20188
...
Global Const DRV_OA_CAMERA_NOT_SUPPORTED = 20194
Global Const DRV_OA_FAILED_TO_GET_MODE = 20195

Global Const DRV_PROCESSING_FAILED = 20211
...
Global Const AC_TRIGGERMODE_EXTERNAL_CHARGESHIFTING = &H80
...
Global Const AC_CAMERATYPE_NEO = 20
Global Const AC_CAMERATYPE_IXONULTRA = 21
Global Const AC_CAMERATYPE_VOLMOS = 22
...
Global Const AC_SETFUNCTION_GATEDELAYSTEP = &H200000
Global Const AC_SETFUNCTION_TRIGGERTERMINATION = &H400000
Global Const AC_SETFUNCTION_EXTENDEDNIR = &H800000
Global Const AC_SETFUNCTION_SPOOLTHREADCOUNT = &H1000000
Global Const AC_SETFUNCTION_REGISTERPACK = &H2000000
Global Const AC_SETFUNCTION_PRESCANS = &H4000000
Global Const AC_SETFUNCTION_GATEWIDTHSTEP = &H8000000
Global Const AC_SETFUNCTION_EXTENDED_CROP_MODE = &H10000000
...
Global Const AC_GETFUNCTION_GATEDELAYSTEP = &H1000
Global Const AC_GETFUNCTION_PHOSPHORSTATUS = &H2000
Global Const AC_GETFUNCTION_MCPGAINTABLE = &H4000
Global Const AC_GETFUNCTION_BASELINECLAMP = &H8000
Global Const AC_GETFUNCTION_GATEWIDTHSTEP = &H10000
...
Global Const AC_FEATURES_OPTACQUIRE = &H100000
Global Const AC_FEATURES_REALTIMESPURIOUSNOISEFILTER = &H200000
Global Const AC_FEATURES_POSTPROCESSSPURIOUSNOISEFILTER = &H400000
Global Const AC_FEATURES_DUALPREAMPGAIN = &H800000
Global Const AC_FEATURES_DEFECT_CORRECTION = &H1000000
Global Const AC_FEATURES_STARTOFEXPOSURE_EVENT = &H2000000
Global Const AC_FEATURES_ENDOFEXPOSURE_EVENT = &H4000000
Global Const AC_FEATURES_CAMERALINK = &H8000000
